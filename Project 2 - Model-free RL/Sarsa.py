...
class Sarsa:
    ...
    # A procedure called initialize values that initializes the Q-values to zero for 
    # all states in the MDP and all relevant other counters and memory.
        self.Q = {}
    ...
    # if more than one action has the max value, select randomly from those top actions
    ...
    # of each algorithm discussed in class or in the Sutton and Barto book.
        ...
        while not terminal and i < 200:
            ...
            # TD update:
            #td_target = reward + self.gamma*Q[S_next][A_next]
